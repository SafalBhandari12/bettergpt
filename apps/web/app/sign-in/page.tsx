      ...
      <div className="w-full max-w-xl">
        <div className="mb-8 text-center">
          ...
          <p className="mt-2 text-sm text-zinc-600 dark:text-zinc-400">
            Your requests run on your own ChatGPT plan. No API key needed.
          </p>
        </div>

        <LoginWithChatGPT consent={{ appName: "BetterGPT" }}>
          {(state) => (
            <SignInFlow
              state={state}
              consented={consented}
    ...
    <div className="space-y-6">
      ...
      {!consented ? (
        <div className="rounded-2xl border border-black/[.08] bg-white p-6 text-sm dark:border-white/[.145] dark:bg-zinc-950">
          <p className="text-zinc-600 dark:text-zinc-400">
            Signing in gives BetterGPT permission to send chat requests on your ChatGPT plan
            until you sign out. Only continue if you trust this app with that access.
          </p>
          <button
            onClick={onConsent}
